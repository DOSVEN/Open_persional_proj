...
adsTrain = audioDatastore(['~/Desktop/MATLAB-thcs-hk/TrainNetworks/enUK/en_UK/by_book/female/elizabeth_klett','/jane_eyre/wavs'],'IncludeSubfolders',true);
% N1=5000;
N1=20; %Number of speech segments read
...
% mel filter bank
bank=full(bank); % Convert sparse matrix to full storage
bank=bank/max(bank(:));
% window
N=windowLength;
m=0:N-1;
